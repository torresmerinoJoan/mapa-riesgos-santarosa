...
function categories_equipamientos_6(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        image: new ol.style.Circle({radius: 4.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(78,175,240,1.0)'})}),
...
var style_equipamientos_6 = function(feature, resolution){
    ...
    var labelText = ""; 
    var value = feature.get("tipo (educacion/salud)");
